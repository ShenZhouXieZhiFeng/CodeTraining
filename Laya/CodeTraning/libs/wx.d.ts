...
declare const wx: {
    ...
    createUserInfoButton(object):any;
    ...
    startGyroscope(object: {success:(res:any)=>void,fail:(res:any)=>void,complete:(res:any)=>void}): void;
    stopGyroscope(object: {success:(res:any)=>void,fail:(res:any)=>void,complete:(res:any)=>void}): void;
    /**
     * 监听设备方向
     */
    onDeviceMotionChange(object: any): void;
    startDeviceMotionListening(object: any): void;
    stopDeviceMotionListening(object?: any): void;
    ...
    onNetworkStatusChange(callback: (res)=>void): void;
     ...
     */
    getUserInfo(object: {openIdList?:any[],withCredentials?:boolean,lang?:string,success?:(res:any)=>void,fail?:(res:any)=>void,complete?:(res:any)=>void}): void;
     ...
     * 监听内存不足告警事件
     */
    onMemoryWarning(callback:(res)=>void):void;
    ...
    createBannerAd(object:{adUnitId:string, style:any}):BannerAd;
     ...
     * @param object
     */
    navigateToMiniProgram(object:{appId?:string, path?:string, extraData?:any, envVersion?:string, success?:(res)=>void, fail?:(res)=>void, complete?:(res)=>void})
    /**
     * 微信环境变量
     */
    env:any;
...
declare interface RewardedVideoAd {
    ...
    onError(callback:(res)=>void):void;
    offError(callback:()=>void):void;
    show():Promise<any>;
}
declare interface BannerAd {
    ...
    onError(callback:(res)=>void):void;
    offError(callback:()=>void):void;
    onResize(callback:(res)=>void):void;
