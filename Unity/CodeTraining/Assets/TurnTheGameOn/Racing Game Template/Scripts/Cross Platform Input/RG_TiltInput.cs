...
namespace TurnTheGameOn.RacingGameTemplate.CrossPlatformInput.PlatformSpecific{
	...
	public class RG_TiltInput : MonoBehaviour{
		...
		private RG_CrossPlatformInputManager.VirtualAxis m_SteerAxis;
...
namespace TurnTheGameOn.RacingGameTemplate.CrossPlatformInput.PlatformSpecific.Inspector{
	#if UNITY_EDITOR
	[CustomPropertyDrawer(typeof (RG_TiltInput.AxisMapping))]
