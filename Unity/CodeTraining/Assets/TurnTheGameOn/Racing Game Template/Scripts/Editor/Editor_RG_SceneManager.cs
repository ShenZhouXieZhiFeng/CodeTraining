...
public class Editor_RG_SceneManager : Editor {
	...
	public override void OnInspectorGUI(){
		...
		if (waypoints) {
			...
			SerializedProperty closeRoute = obj.FindProperty ("closeRoute");
			EditorGUI.BeginChangeCheck ();
			EditorGUILayout.PropertyField (closeRoute, true, GUILayout.MaxWidth (Screen.width * 0.7f));
			if (EditorGUI.EndChangeCheck ())
		...
		if(info){
			EditorGUILayout.HelpBox("Vehicle Number: " + RGT_PlayerPrefs.raceData.vehicleNumber.ToString()
									+ "\nRace Number: " + RGT_PlayerPrefs.raceData.raceNumber.ToString()
			                        //+ "\nRace Name: " + rg_SceneManager.raceName.ToString()
				+ "\nRace Laps: " + RGT_PlayerPrefs.raceData.raceLaps[RGT_PlayerPrefs.raceData.raceNumber].ToString()
									+ "\nPlayer Currency: " + RGT_PlayerPrefs.raceData.currency.ToString()
									+ "\nRace Reward 1st: " + RGT_PlayerPrefs.raceData.raceRewards[0].ToString()
									+ "\nRace Reward 2nd: " + RGT_PlayerPrefs.raceData.raceRewards[1].ToString()
									+ "\nRace Reward 3rd: " + RGT_PlayerPrefs.raceData.raceRewards[2].ToString()
									+ "\nBest Finish Time: " + RGT_PlayerPrefs.raceData.bestRaceTime.ToString()
			                        , MessageType.None);
