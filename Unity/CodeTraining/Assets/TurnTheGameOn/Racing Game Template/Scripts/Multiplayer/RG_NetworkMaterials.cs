...
public class RG_NetworkMaterials : MonoBehaviour {
	...
	public int slot;
	public int glassMaterial;
	public RG_CarCamera camScript;
	...
	void Awake () {
		...
		if (camScript != null) {
			camScript.glassMaterial = objectRef.materials [glassMaterial];
			camScript.defaultGlassAlpha = objectRef.materials [glassMaterial].color.a;
		}
	}
