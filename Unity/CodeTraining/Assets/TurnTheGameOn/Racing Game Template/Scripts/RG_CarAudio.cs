...
public class RG_CarAudio : MonoBehaviour{
	...
	private RG_CarController m_CarController; // Reference to car we are controlling
	...
	private void StartSound(){
		...
		m_CarController = GetComponent<RG_CarController>();
